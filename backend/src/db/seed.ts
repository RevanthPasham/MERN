/**
 * Sample data: banners, categories, collections, products (variants + images), demo user, reviews.
 * Idempotent: safe to run multiple times (findOrCreate / findOrCreate on junction rows).
 *
 * From backend folder: npm run seed
 */
...
const BANNERS = [
  {
    ...
    highlight: "OVERSIZED",
    subtitle: "VIBE",
    cta: "Shop Oversized Tees",
    collectionSlug: "oversized-graphic-tshirt",
  ...
  {
    title: "Graphic",
    highlight: "ROUND NECK",
    subtitle: "T-SHIRTS",
    cta: "Shop Graphic Tees",
    collectionSlug: "graphic-round-neck",
...
const COLLECTIONS = [
  {
    ...
    name: "Oversized Unisex Graphic T-Shirt",
    description: "Shop oversized graphic tees",
  },
  { slug: "best-sellers", name: "Best Sellers", description: "Best selling products" },
  {
    slug: "graphic-round-neck",
    name: "Graphic Round Neck Tshirts",
    description: "Graphic round neck tees",
  },
...
/** Representative catalog: multiple items per collection + best-sellers cross-links */
const PRODUCTS: ProductSeed[] = [
  {
    title: "Yoga Chakras White Round Neck",
    slug: "yoga-chakras-white",
    categorySlug: "yoga-tshirt",
    collectionSlugs: ["yoga-tshirt", "best-sellers"],
    price: 1,
    compareAtPrice: 2,
    images: [IMG.t1, IMG.t2],
  },
  {
    title: "Yoga Flow Stretch Tee",
    slug: "yoga-flow-stretch",
    categorySlug: "yoga-tshirt",
    collectionSlugs: ["yoga-tshirt", "best-sellers"],
    price: 2,
    compareAtPrice: 3,
    images: [IMG.t2, IMG.t3],
  },
  {
    title: "I am a Writer Navy Blue",
    slug: "i-am-a-writer-navy-blue",
    categorySlug: "writer-tshirt",
    collectionSlugs: ["writer-tshirt", "best-sellers"],
    price: 2,
    compareAtPrice: 3,
    images: [IMG.t4, IMG.t5],
  },
  {
    title: "Writer's Block Black",
    slug: "writers-block-black",
    categorySlug: "writer-tshirt",
    collectionSlugs: ["writer-tshirt", "best-sellers"],
    price: 1,
    compareAtPrice: 2,
    images: [IMG.t6, IMG.t1],
  },
  {
    title: "Advocate Logo White Lawyer Polo",
    slug: "advocate-logo-pocket-white",
    categorySlug: "lawyer-polo",
    collectionSlugs: ["lawyer-polo", "best-sellers"],
    price: 1,
    compareAtPrice: 2,
    images: [IMG.t7, IMG.t8],
  },
  {
    title: "Legal Eagle Navy Polo",
    slug: "legal-eagle-navy-polo",
    categorySlug: "lawyer-polo",
    collectionSlugs: ["lawyer-polo", "best-sellers"],
    price: 2,
    compareAtPrice: 3,
    images: [IMG.t5, IMG.t7],
  },
  {
    title: "Journalist Verified Navy",
    slug: "journalist-verified-navy-blue",
    categorySlug: "journalism-tshirt",
    collectionSlugs: ["journalism-tshirt", "best-sellers"],
    price: 2,
    compareAtPrice: 3,
    images: [IMG.t2, IMG.t3],
  },
  {
    title: "News Breaker Black",
    slug: "news-breaker-black",
    categorySlug: "journalism-tshirt",
    collectionSlugs: ["journalism-tshirt", "best-sellers"],
    price: 1,
    compareAtPrice: 2,
  ...
  {
    title: "Chef Street Style Black",
    slug: "chef-street-style-black",
    categorySlug: "chef-tshirt",
    collectionSlugs: ["chef-tshirt", "best-sellers"],
    price: 1,
    compareAtPrice: 2,
    images: [IMG.t6, IMG.t1],
  },
  {
    title: "Kitchen King White",
    slug: "kitchen-king-white",
    categorySlug: "chef-tshirt",
    collectionSlugs: ["chef-tshirt", "best-sellers"],
    price: 2,
    compareAtPrice: 3,
    images: [IMG.t1, IMG.t7],
  },
  {
    title: "Depends on the day Black Graphic",
    slug: "depends-on-the-day-black",
    categorySlug: "graphic-round-neck",
    collectionSlugs: ["graphic-round-neck", "best-sellers"],
    price: 2,
    compareAtPrice: 3,
    images: [IMG.t8, IMG.t2],
  },
  {
    title: "Space Pocket Black Graphic",
    slug: "space-pocket-black",
    categorySlug: "graphic-round-neck",
    collectionSlugs: ["graphic-round-neck", "best-sellers"],
    price: 1,
    compareAtPrice: 2,
    images: [IMG.t6, IMG.t4],
  },
  {
    title: "Fibonacci Black Oversized",
    slug: "fibonacci-black",
    categorySlug: "oversized-graphic-tshirt",
    collectionSlugs: ["oversized-graphic-tshirt", "best-sellers"],
    price: 1,
    compareAtPrice: 2,
    images: [IMG.t1, IMG.t2],
  },
  {
    title: "30000FT Flight Crew Black",
    slug: "30000ft-black-flight-crew",
    categorySlug: "oversized-graphic-tshirt",
    collectionSlugs: ["oversized-graphic-tshirt", "best-sellers"],
    price: 2,
    compareAtPrice: 3,
  ...
  {
    title: "Oversized Urban Grey",
    slug: "oversized-urban-grey",
    categorySlug: "oversized-graphic-tshirt",
    collectionSlugs: ["oversized-graphic-tshirt", "best-sellers"],
    price: 1,
    compareAtPrice: 2,
    images: [IMG.t2, IMG.t5],
  },
];

const REVIEW_SEEDS: { slug: string; rating: number; comment: string }[] = [
...
export async function populateInitialData(): Promise<void> {
  ...
  for (const c of COLLECTIONS) {
    ...
    if (!row.bannerImage && bannerImage) {
      await row.update({ bannerImage });
    }
    collectionMap[c.slug] = row;
  }
  for (const c of CATEGORIES) {
  ...
  for (const p of PRODUCTS) {
    ...
    for (let i = 0; i < p.images.length; i++) {
      await ProductImage.findOrCreate({
        where: { variantId: variant.id, url: p.images[i] },
        defaults: {
          variantId: variant.id,
          url: p.images[i],
          sortOrder: i,
  ...
  for (const r of REVIEW_SEEDS) {
    ...
    await ProductReview.findOrCreate({
      where: { productId: prod.id, comment: r.comment },
      defaults: {
        productId: prod.id,
        userId: demoUserId,
        userName: "Demo User",
  ...
  console.log(
    `Seed complete: demo user, ${BANNERS.length} banners, ${CATEGORIES.length} categories, ${COLLECTIONS.length} collections, ${PRODUCTS.length} products, reviews.`
  );
}

/** Re-sync collection links and prices from PRODUCTS (safe to run after manual DB edits). */
export async function ensureCollectionLinksAndPrices(): Promise<void> {
  ...
  const collectionRows = await Collection.findAll({
    where: { slug: { [Op.in]: allSlugs } },
    attributes: ["id", "slug"],
  });
  ...
  for (const p of PRODUCTS) {
    const prod = await Product.findOne({ where: { slug: p.slug } });
    if (!prod) continue;
    ...
    for (const slug of p.collectionSlugs) {
      ...
      if (collectionId) {
        await ProductCollection.findOrCreate({
          where: { productId: prod.id, collectionId },
          defaults: { productId: prod.id, collectionId },
        });
      }
    }
  }
  console.log("Collection links and prices synced from seed definitions.");
}
